        ...
        <div class="pull-right" style="margin-bottom: 5px">
            <p class="margin-large-top btn-group pull-right">
                <a class="btn btn-primary"
                   href="<s:url namespace="/do/FileBrowser" action="uploadNewFileEntry" ><s:param name="currentPath"><s:property escapeHtml="true" value="%{#currentPath}"/></s:param><s:param name="protectedFolder"><s:property value="%{getProtectedFolder()}"/></s:param></s:url>">
                    <span class="icon fa fa-upload"></span>&#32;<s:text
                        name="label.upload" />
                </a> <a class="btn btn-primary pull-right"
                        href="<s:url namespace="/do/FileBrowser" action="newFileEntry" ><s:param name="currentPath"><s:property escapeHtml="true" value="%{#currentPath}"/></s:param><s:param name="protectedFolder"><s:property value="%{getProtectedFolder()}"/></s:param></s:url>">
                    <span class="icon fa fa-file-text"></span>&#32;<s:text
                        name="label.addTextFile" />
                </a> <a class="btn btn-primary pull-right"
                        href="<s:url namespace="/do/FileBrowser" action="newDirEntry" ><s:param name="currentPath"><s:property escapeHtml="true" value="%{#currentPath}"/></s:param><s:param name="protectedFolder"><s:property value="%{getProtectedFolder()}"/></s:param></s:url>">
                ...
                <s:if test="%{null != getProtectedFolder()}">
                    <tr>
                        ...
                        <th><s:if test="currentPath!=''">
                                ...
                                href="<s:url namespace="/do/FileBrowser" action="list" ><s:param name="protectedFolder" value="#isUpProtectedFileVar" /><s:param name="currentPath"><s:property escapeHtml="true" value="breadCrumbsTargets.get(breadCrumbsTargets.size()-2).key"/></s:param></s:url>">
                    ...
                    <tr>
                        ...
                        <td class="text-nowrap"><s:if test="#fileVar.directory">
                                <a class="display-block"
                                   href="<s:url namespace="/do/FileBrowser" action="list" ><s:param name="currentPath"><s:property escapeHtml="true" value="currentPath"/><s:property escapeHtml="true" value="#filenameVar"/></s:param><s:param name="protectedFolder"><s:property value="#isProtectedFileVar"/></s:param></s:url>">
                                ...
                                <s:if test="%{isTextFile(#fileVar.name)}">
                                    <a class="display-block"
                                       ...
                                       href="<s:url namespace="/do/FileBrowser" action="edit" ><s:param name="currentPath"><s:property escapeHtml="true" value="%{#currentPath}"/></s:param><s:param name="filename"> <s:property escapeHtml="false" value="#filenameVar"/></s:param><s:param name="protectedFolder"><s:property value="#isProtectedFileVar"/></s:param></s:url>">
                                ...
                                <s:else>
                                    <a class="display-block"
                                       ...
                                       href="<s:url namespace="/do/FileBrowser" action="download" ><s:param name="currentPath"><s:property escapeHtml="true" value="%{#currentPath}"/></s:param><s:param name="filename"> <s:property escapeHtml="false" value="#filenameVar"/></s:param><s:param name="protectedFolder"><s:property value="#isProtectedFileVar"/></s:param></s:url>">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <s:if test="!#fileVar.directory">
                                        ...
                                        <li><a
                                                ...
                                                href="<s:url namespace="/do/FileBrowser" action="trash" ><s:param name="currentPath"><s:property escapeHtml="true" value="%{#currentPath}"/></s:param><s:param name="filename"><s:property value="#fileVar.name"/></s:param><s:param name="deleteFile" value="%{!#fileVar.directory}" /><s:param name="protectedFolder"><s:property value="#isProtectedFileVar"/></s:param></s:url>">

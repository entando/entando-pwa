...
INSERT INTO pages_metadata_online (code,titles,modelcode,showinmenu,extraconfig,updatedat) VALUES ('pwa','<?xml version="1.0" encoding="UTF-8"?>
<properties>
<property key="en">pwa</property>
<property key="it">pwa</property>
</properties>

','pwa',1,'<?xml version="1.0" encoding="UTF-8"?>
<config>
